---
title: "Knowledge Graph Functions in NFDI"
collection: publications
permalink: /publication/knowledge-graph-functions-in-nfdi/
excerpt: 'The dataset contains use case examples from Knowledge Graph (KG) projects across the NFDI consortia, including the KG names, as well as the challenges the consortia faced in the process of employing a KG for the consortium. Lastly, the functions supported by the KGs are…'
date: 2025-08-07
