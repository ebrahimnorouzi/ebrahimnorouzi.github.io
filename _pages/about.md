...
- **2025** &mdash; Paper at [NSLP @ ESWC 2025](https://arxiv.org/abs/2504.12915){:target="_blank"}: *ConExion: Concept Extraction with Large Language Models*
- **2024** &mdash; Survey on [Ontologies in Materials Science &amp; Engineering](https://arxiv.org/abs/2408.06034){:target="_blank"} at SeMatS @ SEMANTICS 2024
- **2024** &mdash; Journal paper in [Experimental Mechanics](https://doi.org/10.1007/s11340-024-01057-x){:target="_blank"}: data-driven Chaboche model parameter identification
- **2024** &mdash; [OAEI ML Dataset for Online Model Generation](https://arxiv.org/abs/2404.18542){:target="_blank"} &mdash; ESWC 2024 Poster
